...
int32_t rl2_CheckCollisionBoxSphere(void* box, int32_t box_len, float center_x, float center_y, float center_z, float radius);
int32_t rl2_CheckCollisionBoxes(void* box1, int32_t box1_len, void* box2, int32_t box2_len);
...
int32_t rl2_CheckCollisionLines(float startPos1_x, float startPos1_y, float endPos1_x, float endPos1_y, float startPos2_x, float startPos2_y, float endPos2_x, float endPos2_y, void* collisionPoint, int32_t collisionPoint_len);
...
int32_t rl2_CheckCollisionPointPoly(float point_x, float point_y, void* points, int32_t pointCount);
...
char* rl2_CodepointToUTF8(int32_t codepoint, void* utf8Size, int32_t utf8Size_len);
int32_t rl2_ColorAlpha(int32_t color_rgba, float alpha, void* ret_out, int32_t ret_out_len);
int32_t rl2_ColorAlphaBlend(int32_t dst_rgba, int32_t src_rgba, int32_t tint_rgba, void* ret_out, int32_t ret_out_len);
int32_t rl2_ColorBrightness(int32_t color_rgba, float factor, void* ret_out, int32_t ret_out_len);
int32_t rl2_ColorContrast(int32_t color_rgba, float contrast, void* ret_out, int32_t ret_out_len);
int32_t rl2_ColorFromHSV(float hue, float saturation, float value, void* ret_out, int32_t ret_out_len);
int32_t rl2_ColorFromNormalized(float normalized_x, float normalized_y, float normalized_z, float normalized_w, void* ret_out, int32_t ret_out_len);
int32_t rl2_ColorIsEqual(int32_t col1_rgba, int32_t col2_rgba);
int32_t rl2_ColorLerp(int32_t color1_rgba, int32_t color2_rgba, float factor, void* ret_out, int32_t ret_out_len);
int32_t rl2_ColorNormalize(int32_t color_rgba, void* ret_out, int32_t ret_out_len);
int32_t rl2_ColorTint(int32_t color_rgba, int32_t tint_rgba, void* ret_out, int32_t ret_out_len);
int32_t rl2_ColorToHSV(int32_t color_rgba, void* ret_out, int32_t ret_out_len);
int32_t rl2_ColorToInt(int32_t color_rgba);
void* rl2_CompressData(void* data, int32_t dataSize, void* compDataSize);
int32_t rl2_ComputeCRC32(void* data, int32_t dataSize);
void* rl2_ComputeMD5(void* data, int32_t dataSize);
void* rl2_ComputeSHA1(void* data, int32_t dataSize);
void* rl2_ComputeSHA256(void* data, int32_t dataSize);
void* rl2_DecodeDataBase64(char* text, void* outputSize, int32_t outputSize_len);
void* rl2_DecompressData(void* compData, int32_t compDataSize, void* dataSize);
...
void rl2_DrawBoundingBox(void* box, int32_t box_len, int32_t color_rgba);
...
void rl2_DrawLineStrip(void* points, int32_t pointCount, int32_t color_rgba);
void rl2_DrawLineV(float startPos_x, float startPos_y, float endPos_x, float endPos_y, int32_t color_rgba);
void rl2_DrawMesh(void* mesh, void* material, void* transform, int32_t transform_len);
void rl2_DrawMeshInstanced(void* mesh, void* material, void* transforms, int32_t instances);
...
void rl2_DrawSplineBasis(void* points, int32_t pointCount, float thick, int32_t color_rgba);
void rl2_DrawSplineBezierCubic(void* points, int32_t pointCount, float thick, int32_t color_rgba);
void rl2_DrawSplineBezierQuadratic(void* points, int32_t pointCount, float thick, int32_t color_rgba);
void rl2_DrawSplineCatmullRom(void* points, int32_t pointCount, float thick, int32_t color_rgba);
void rl2_DrawSplineLinear(void* points, int32_t pointCount, float thick, int32_t color_rgba);
...
void rl2_DrawTextCodepoints(void* font, void* codepoints, int32_t codepointCount, float position_x, float position_y, float fontSize, float spacing, int32_t tint_rgba);
...
void rl2_DrawTriangleFan(void* points, int32_t pointCount, int32_t color_rgba);
void rl2_DrawTriangleLines(float v1_x, float v1_y, float v2_x, float v2_y, float v3_x, float v3_y, int32_t color_rgba);
void rl2_DrawTriangleStrip(void* points, int32_t pointCount, int32_t color_rgba);
void rl2_DrawTriangleStrip3D(void* points, int32_t pointCount, int32_t color_rgba);
void rl2_EnableCursor(void);
void rl2_EnableEventWaiting(void);
char* rl2_EncodeDataBase64(void* data, int32_t dataSize, void* outputSize);
...
int32_t rl2_ExportDataAsCode(void* data, int32_t dataSize, char* fileName);
...
void* rl2_ExportImageToMemory(void* image, char* fileType, void* fileSize, int32_t fileSize_len);
...
int32_t rl2_Fade(int32_t color_rgba, float alpha, void* ret_out, int32_t ret_out_len);
...
int32_t rl2_GetCameraMatrix(void* camera, void* ret_out, int32_t ret_out_len);
int32_t rl2_GetCameraMatrix2D(void* camera, void* ret_out, int32_t ret_out_len);
int32_t rl2_GetCharPressed(void);
void* rl2_GetClipboardImage(void);
char* rl2_GetClipboardText(void);
int32_t rl2_GetCodepoint(char* text, void* codepointSize, int32_t codepointSize_len);
int32_t rl2_GetCodepointCount(char* text);
int32_t rl2_GetCodepointNext(char* text, void* codepointSize, int32_t codepointSize_len);
int32_t rl2_GetCodepointPrevious(char* text, void* codepointSize, int32_t codepointSize_len);
int32_t rl2_GetCollisionRec(float rec1_x, float rec1_y, float rec1_w, float rec1_h, float rec2_x, float rec2_y, float rec2_w, float rec2_h, void* ret_out, int32_t ret_out_len);
int32_t rl2_GetColor(int32_t hexValue, void* ret_out, int32_t ret_out_len);
...
int32_t rl2_GetGestureDragVector(void* ret_out, int32_t ret_out_len);
float rl2_GetGestureHoldDuration(void);
float rl2_GetGesturePinchAngle(void);
int32_t rl2_GetGesturePinchVector(void* ret_out, int32_t ret_out_len);
int32_t rl2_GetGlyphAtlasRec(void* font, int32_t codepoint, void* ret_out, int32_t ret_out_len);
int32_t rl2_GetGlyphIndex(void* font, int32_t codepoint);
void* rl2_GetGlyphInfo(void* font, int32_t codepoint);
int32_t rl2_GetImageAlphaBorder(void* image, float threshold, void* ret_out, int32_t ret_out_len);
int32_t rl2_GetImageColor(void* image, int32_t x, int32_t y, void* ret_out, int32_t ret_out_len);
...
int32_t rl2_GetMonitorPosition(int32_t monitor, void* ret_out, int32_t ret_out_len);
int32_t rl2_GetMonitorRefreshRate(int32_t monitor);
int32_t rl2_GetMonitorWidth(int32_t monitor);
int32_t rl2_GetMouseDelta(void* ret_out, int32_t ret_out_len);
int32_t rl2_GetMousePosition(void* ret_out, int32_t ret_out_len);
float rl2_GetMouseWheelMove(void);
int32_t rl2_GetMouseWheelMoveV(void* ret_out, int32_t ret_out_len);
...
int32_t rl2_GetPixelColor(void* srcPtr, int32_t format, void* ret_out, int32_t ret_out_len);
...
void* rl2_GetRayCollisionBox(void* ray, void* box, int32_t box_len);
void* rl2_GetRayCollisionMesh(void* ray, void* mesh, void* transform, int32_t transform_len);
...
int32_t rl2_GetScreenToWorld2D(float position_x, float position_y, void* camera, void* ret_out, int32_t ret_out_len);
...
int32_t rl2_GetShapesTextureRectangle(void* ret_out, int32_t ret_out_len);
int32_t rl2_GetSplinePointBasis(float p1_x, float p1_y, float p2_x, float p2_y, float p3_x, float p3_y, float p4_x, float p4_y, float t, void* ret_out, int32_t ret_out_len);
int32_t rl2_GetSplinePointBezierCubic(float p1_x, float p1_y, float c2_x, float c2_y, float c3_x, float c3_y, float p4_x, float p4_y, float t, void* ret_out, int32_t ret_out_len);
int32_t rl2_GetSplinePointBezierQuad(float p1_x, float p1_y, float c2_x, float c2_y, float p3_x, float p3_y, float t, void* ret_out, int32_t ret_out_len);
int32_t rl2_GetSplinePointCatmullRom(float p1_x, float p1_y, float p2_x, float p2_y, float p3_x, float p3_y, float p4_x, float p4_y, float t, void* ret_out, int32_t ret_out_len);
int32_t rl2_GetSplinePointLinear(float startPos_x, float startPos_y, float endPos_x, float endPos_y, float t, void* ret_out, int32_t ret_out_len);
...
int32_t rl2_GetTouchPosition(int32_t index, void* ret_out, int32_t ret_out_len);
int32_t rl2_GetTouchX(void);
int32_t rl2_GetTouchY(void);
void* rl2_GetWindowHandle(void);
int32_t rl2_GetWindowPosition(void* ret_out, int32_t ret_out_len);
int32_t rl2_GetWindowScaleDPI(void* ret_out, int32_t ret_out_len);
char* rl2_GetWorkingDirectory(void);
int32_t rl2_GetWorldToScreen(float position_x, float position_y, float position_z, void* camera, void* ret_out, int32_t ret_out_len);
int32_t rl2_GetWorldToScreen2D(float position_x, float position_y, void* camera, void* ret_out, int32_t ret_out_len);
int32_t rl2_GetWorldToScreenEx(float position_x, float position_y, float position_z, void* camera, int32_t width, int32_t height, void* ret_out, int32_t ret_out_len);
...
void rl2_ImageDrawTriangleFan(void* dst, void* points, int32_t pointCount, int32_t color_rgba);
...
void rl2_ImageDrawTriangleStrip(void* dst, void* points, int32_t pointCount, int32_t color_rgba);
...
void rl2_ImageKernelConvolution(void* image, void* kernel, int32_t kernelSize);
...
void* rl2_LoadCodepoints(char* text, void* count, int32_t count_len);
...
void* rl2_LoadFileData(char* fileName, void* dataSize, int32_t dataSize_len);
char* rl2_LoadFileText(char* fileName);
void* rl2_LoadFont(char* fileName);
void* rl2_LoadFontData(void* fileData, int32_t dataSize, int32_t fontSize, void* codepoints, int32_t codepointCount, int32_t type, void* glyphCount);
void* rl2_LoadFontEx(char* fileName, int32_t fontSize, void* codepoints, int32_t codepointCount);
void* rl2_LoadFontFromImage(void* image, int32_t key_rgba, int32_t firstChar);
void* rl2_LoadFontFromMemory(char* fileType, void* fileData, int32_t dataSize, int32_t fontSize, void* codepoints, int32_t codepointCount);
void* rl2_LoadImage(char* fileName);
void* rl2_LoadImageAnim(char* fileName, void* frames, int32_t frames_len);
void* rl2_LoadImageAnimFromMemory(char* fileType, void* fileData, int32_t dataSize, void* frames);
void* rl2_LoadImageColors(void* image);
void* rl2_LoadImageFromMemory(char* fileType, void* fileData, int32_t dataSize);
void* rl2_LoadImageFromScreen(void);
void* rl2_LoadImageFromTexture(void* texture);
void* rl2_LoadImagePalette(void* image, int32_t maxPaletteSize, void* colorCount);
...
void* rl2_LoadMaterials(char* fileName, void* materialCount, int32_t materialCount_len);
void* rl2_LoadModel(char* fileName);
void* rl2_LoadModelAnimations(char* fileName, void* animCount, int32_t animCount_len);
void* rl2_LoadModelFromMesh(void* mesh);
void* rl2_LoadMusicStream(char* fileName);
void* rl2_LoadMusicStreamFromMemory(char* fileType, void* data, int32_t dataSize);
...
char* rl2_LoadTextLines(char* text, void* count, int32_t count_len);
...
char* rl2_LoadUTF8(void* codepoints, int32_t length);
void* rl2_LoadVrStereoConfig(void* device);
void* rl2_LoadWave(char* fileName);
void* rl2_LoadWaveFromMemory(char* fileType, void* fileData, int32_t dataSize);
...
int32_t rl2_MeasureTextEx(void* font, char* text, float fontSize, float spacing, void* ret_out, int32_t ret_out_len);
...
void rl2_SetShaderValueMatrix(void* shader, int32_t locIndex, void* mat, int32_t mat_len);
...
void rl2_TextAppend(char* text, char* append, void* position, int32_t position_len);
...
char* rl2_TextSplit(char* text, int32_t delimiter, void* count, int32_t count_len);
